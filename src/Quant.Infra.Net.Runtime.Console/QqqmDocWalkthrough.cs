...
public static class QqqmDocWalkthrough
{
    ...
    public static async Task<int> RunAsync()
    {
        ...
        C.WriteLine();
        C.WriteLine("==========================================================");
        C.WriteLine("  Report generated by Quant.Infra.Net v1.5.3");
        C.WriteLine("  Code:   github.com/memoryfraction/Quant.Infra.Net");
        C.WriteLine("  E-book: amazon.com/dp/B0D7W89ZQD");
        C.WriteLine("==========================================================");
        C.WriteLine("done.");
